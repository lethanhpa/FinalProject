...
function SellingProduct({ products, reviews }) {
  ...
  const calculateSoldCount = (initialQuantity, currentStock) => {
    return initialQuantity - currentStock;
  };
    ...
    <div className="pt-[2.5rem]">
      ...
      <div className="flex pb-[4.3125rem] border-b border-primry pt-[1.25rem]">
        ...
        >
          {products &&
            products.map((item) => {
              const soldCount = calculateSoldCount(item.initialQuantity, item.currentStock);
              return (
                <SwiperSlide key={item.id}>
                  ...
                  >
                    ...
                    <div className="flex flex-col gap-[6px]">
                      ...
                      <span className="font-roboto text-md flex justify-center text-gray">
                        Đã bán: {numeral(soldCount).format("0,0")}
                      </span>
                      <Divider>
                        <Button
