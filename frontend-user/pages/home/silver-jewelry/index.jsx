    ...
    return (
        <div>
            <div className="mt-[3.125rem] flex justify-center w-full">
                <img src="./img/trang-suc-bac-1.jpg" alt="trang-suc-bac" className="lg:w-[1200px] h-[30rem]" />
            </div>
            ...
            <div className="flex pb-[2.5rem] pt-[1.25rem]">
                ...
                >
                    {products &&
                        products.filter(product => product.productName.toLowerCase().includes("bạc")).map((item) => {
                            return (
