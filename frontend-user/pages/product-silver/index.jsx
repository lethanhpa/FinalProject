...
function ProductSilver({ products }) {
    ...
    return (
        <>
            <div className="grid grid-cols-5 gap-2 container">
                {products && products.filter(product => product.productName.toLowerCase().includes("bạc")).map((item) => {
                    return (
...
export default memo(ProductSilver);
