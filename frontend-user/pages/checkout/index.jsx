  ...
  return (
    <div className="container ssm:flex block  ">
      ...
      <div className="flex-1 ">
        ...
        <div>
          <button className="bg-primry text-white font-bold py-1 px-4 rounded-full hover:bg-white hover:text-primry hover:border-primry hover:border mx-auto flex items-end mb-6">
            Buy Now
          </button>
        </div>
      </div>
