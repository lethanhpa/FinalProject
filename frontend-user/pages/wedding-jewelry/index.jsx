...
function WeddingJewelry({ products, categories }) {
    ...
    <>
      <div className="container mt-5 font-roboto">
        ...
        <div className="grid lg:grid-cols-4 gap-10 md:grid-cols-3 sm:grid-cols-2 mx-2.5">
          {filteredProducts.filter((item) => item.categoryId === "65d72854f159c29036e3b592").slice(0, visibleProducts).map((item) => (
            <div
              key={item._id}
            ...
            >
              ...
              <div className="flex flex-col gap-[6px]">
                ...
                <Divider>
                  <Link
                    href={`/${item.id}`}
                    className="bg-slate-800 text-white hover:bg-white hover:text-black text-sm font-light py-2 px-3 font-roboto border border-gray rounded-md"
                  >
                    Chi tiết
                  </Link>
                </Divider>
        ...
        <span className="flex justify-center font-elle mt-7 mb-3">
          Hiển thị {Math.min(filteredProducts.filter(item => item.categoryId === "65d72854f159c29036e3b592").length, visibleProducts)}/
          {filteredProducts.filter(item => item.categoryId === "65d72854f159c29036e3b592").length}
        </span>
        {filteredProducts.filter(item => item.categoryId === "65d72854f159c29036e3b592").length > visibleProducts && (
          <button
      ...
      <div className="container mt-5 font-roboto">
        ...
        <div className="grid lg:grid-cols-4 gap-10 md:grid-cols-3 sm:grid-cols-2 mx-2.5">
          {filteredProducts.filter((item) => item.categoryId === "65f12a3743051681d5a2c8bd").slice(0, visibleProducts).map((item) => (
            <div
              key={item._id}
              className="sm:min-w-[15.625rem] sm:min-h-[12.5rem] min-w-[100px] min-h-[100px] shadow-md rounded hover:bg-second-3 flex flex-col justify-center items-center"
              style={{
        ...
        <span className="flex justify-center font-elle mt-7 mb-3">
          Hiển thị {Math.min(filteredProducts.filter(item => item.categoryId === "65f12a3743051681d5a2c8bd").length, visibleProducts)}/
          {filteredProducts.filter(item => item.categoryId === "65f12a3743051681d5a2c8bd").length}
        </span>
        {filteredProducts.filter(item => item.categoryId === "65f12a3743051681d5a2c8bd").length > visibleProducts && (
          <button
            className=" block mx-auto py-3 px-5 mb-10 border border-primry text-black bg-white hover:bg-primry hover:text-white transition-colors duration-300"
            onClick={handleShowMore}
          >
